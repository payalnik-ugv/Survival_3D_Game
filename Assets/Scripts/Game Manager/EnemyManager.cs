...
public class EnemyManager : MonoBehaviour {
    ...
    public void EnemyDied(bool isCannibal)
    {
        if (isCannibal) {
            ...
            if (cannibal_Enemy_Count > initial_Cannibal_Count) cannibal_Enemy_Count = initial_Cannibal_Count;
        } else {
            boar_Enemy_Count++;
            if (boar_Enemy_Count > initial_Boar_Count) boar_Enemy_Count = initial_Boar_Count;
        }
    }
